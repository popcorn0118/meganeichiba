...
define( 'ASTRA_PRO_SITES_VER', '4.6.0' );
...
if ( ! function_exists( 'astra_pro_sites_deactivate' ) ) :
	 ...
	 * @return void
	 */
	function astra_pro_sites_deactivate() {
	...
	register_deactivation_hook( __FILE__, 'astra_pro_sites_deactivate' );
