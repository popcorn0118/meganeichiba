...
function bsf_systeminfo() {
	...
	<table class="wp-list-table widefat fixed bsf-sys-info">
		<tbody>
		<tr class="alternate">
			<th colspan="2"><?php esc_html_e( 'WordPress Environment', 'bsf-core' ); ?></th>
		</tr>
		<tr>
			<td>Home URL</td>
	...
	<table class="wp-list-table widefat fixed bsf-sys-info">
		<tbody>
		<tr class="alternate">
			<th colspan="2"><?php esc_html_e( 'Server Environment', 'bsf-core' ); ?></th>
		</tr>
		<tr>
			<td>Server Info</td>
	...
	<table class="wp-list-table widefat fixed bsf-sys-info">
		<tbody>
		<tr class="alternate">
			<th colspan="2"><?php esc_html_e( 'Theme Information', 'bsf-core' ); ?></th>
		</tr>
	...
	<table class="wp-list-table widefat fixed bsf-sys-info bsf-table-active-plugin">
		<tbody>
		<tr class="alternate">
			<th colspan="4"><?php esc_html_e( 'Installed Plugins', 'bsf-core' ); ?></th>
		</tr>
		<?php
		$plugins = get_plugins();
		asort( $plugins );
