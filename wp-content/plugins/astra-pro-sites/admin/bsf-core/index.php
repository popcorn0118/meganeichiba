	...
	function register_bsf_extension_page_network() {
		...
		foreach ( $themes as $theme ) {
			if ( 'iMedica' === $theme->Name ) { // phpcs:ignore WordPress.NamingConventions.ValidVariableName.UsedPropertyNotSnakeCase
				add_submenu_page( $parent_slug, __( 'iMedica Extensions', 'bsf-core' ), __( 'iMedica Extensions', 'bsf-core' ), 'manage_options', 'bsf-extensions-10395942', 'bsf_extensions_callback' );
				break;
			}
		}
	}
